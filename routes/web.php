...
Route::resource('/admin/materi', App\Http\Controllers\Admin\MataPelajaranController::class)->except('show');
Route::resource('/admin/topik', App\Http\Controllers\Admin\MateriController::class)->except('show');
Route::resource('/admin/kuis', App\Http\Controllers\Admin\SoalController::class)->except('show');
